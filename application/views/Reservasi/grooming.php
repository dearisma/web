                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                ...
                                <h1 class="h4 text-gray-900 mb-4">Formulir Grooming</h1>
                            </div>
                            
                            <form action="<?= base_url('Reservasi/tambah_grooming'); ?>" class="user" method="POST">
                            
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                    <label for="foto">Tanggal Grooming</label>
                                    <input type="date" id="tgl_grooming" name="tgl_grooming" class="form-control form-control-user" placeholder="Tanggal Grooming *" value="" />
