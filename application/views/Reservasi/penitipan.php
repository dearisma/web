                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Formulir Penitipan</h1>
                            </div>
                            <form action="<?= base_url('Reservasi/tambah_penitipan'); ?>" class="user" method="POST">
                            
                           
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                    <label for="foto">Tanggal Titip</label>
                                    <input type="date" id="tgl_titip" name="tgl_grooming" class="form-control form-control-user" placeholder="Tanggal Titip *" value="" />
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                    <label for="foto">Tanggal Ambil</label>
                                    <input type="date" id="tgl_ambil" name="tgl_grooming" class="form-control form-control-user" placeholder="Tanggal Ambil *" value="" />
                                    </div>
                                </div>
                                <div class="form-group">
                                <label for="foto">Nama</label>
                                <input type="text" class="form-control form-control-user" value="<?= $log['nama']; ?>" readonly> 
                                </div>
                                ...
                                <input type="text" class="form-control form-control-user" value="<?= $log['no_telp']; ?>"> 
                                </div>
                                <div class="form-group">
